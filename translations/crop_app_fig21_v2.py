"""Crop Figure 21 from p.70 - v2 (just the figure, no equation refs above)."""
from PIL import Image
import numpy as np

img = Image.open(r"C:\Users\ZhangMH\Desktop\MIT6.S184\translations\work\pages\page_70.png")
# The actual figure starts at about y=1280 (where the marginal PDF curve starts)
crop = img.crop((1280, 1280, 1620, 1950))
