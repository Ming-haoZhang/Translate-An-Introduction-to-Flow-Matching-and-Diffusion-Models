...
$$
\begin{aligned}
X_{t+h} &= X_t + h\, u_t(X_t) + \sigma_t(W_{t+h} - W_t) + h\, R_t(h) ^{ (6) } \\
&\underbrace{\phantom{xxxxxxxxxxxxxxxx}}_{\text{确定性项}}\ \underbrace{\phantom{xxxxxxxx}}_{\text{随机项}}\ \underbrace{\phantom{xxxxxxxx}}_{\text{误差项}}
\end{aligned}
$$
