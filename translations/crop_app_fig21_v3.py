"""Crop Figure 21 from p.70 - v3 (tight, just the figure body)."""
from PIL import Image
import numpy as np

img = Image.open(r"C:\Users\ZhangMH\Desktop\MIT6.S184\translations\work\pages\page_70.png")
# Figure 21: marginal PDF starts ~y=1330, joint PDF contour starts ~y=1430
# bottom of contour ~y=1820, side marginal ~y=1430-1900
crop = img.crop((1280, 1320, 1620, 1900))
