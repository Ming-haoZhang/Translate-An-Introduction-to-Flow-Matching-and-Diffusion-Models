"""Crop Figure 21 from p.70 (joint PDF + marginals)."""
from PIL import Image
import numpy as np

img = Image.open(r"C:\Users\ZhangMH\Desktop\MIT6.S184\translations\work\pages\page_70.png")
# Figure 21 in right column, lower portion of p.70
# Roughly: x=1280-1620, y=1100-1900
crop = img.crop((1280, 1100, 1620, 1950))
