"""Crop Figure 22 v2 - need wider left margin to capture row labels."""
...
# Need to include left labels (Tokenizer Specification, Latent Distribution, etc.)
# Original page x=1700. Figure 22 starts around x=180 (after page margin)
crop = img.crop((180, 180, 1700 - 100, 700))
